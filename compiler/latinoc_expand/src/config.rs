...
use latinoc_ast::token::{DelimToken, Token, TokenKind};
use latinoc_ast::tokenstream::{AttrAnnotatedTokenStream, AttrAnnotatedTokenTree};
use latinoc_ast::tokenstream::{DelimSpan, Spacing};
use latinoc_ast::tokenstream::{LazyTokenStream, TokenTree};
use latinoc_ast::{self as ast, AstLike, AttrStyle, Attribute, MetaItem};
...
use latinoc_span::edition::{Edition, ALL_EDITIONS};
...
impl<'a> StripUnconfigured<'a> {
    ...
    fn process_cfg_attr(&mut self, attr: Attribute) -> Vec<Attribute> {
        ...
        let (cfg_predicate, expanded_attrs) =
            match latinoc_parse::parse_cfg_attr(&attr, &self.sess.parse_sess) {
                None => return vec![],
                Some(r) => r,
            };
