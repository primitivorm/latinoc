...
use latinoc_ast::{AstLike, Block, Inline, ItemKind, MacArgs, MacCall};
use latinoc_ast::{MacCallStmt, MacStmtStyle, MetaItemKind, ModKind, NestedMetaItem};
use latinoc_ast::{NodeId, PatKind, Path, StmtKind, Unsafe};
...
use latinoc_span::{FileName, LocalExpnId, Span};
            ...
            InvocationKind::Attr { attr, pos, mut item, derives } => match ext {
                SyntaxExtensionKind::Attr(expander) => {
                    ...
                    let tokens = if fake_tokens {
                        latinoc_parse::fake_token_stream(
