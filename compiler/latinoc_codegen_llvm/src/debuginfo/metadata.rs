...
use latinoc_span::FileNameDisplayPreference;
use latinoc_span::{self, SourceFile, SourceFileHash, Span};
...
fn trait_pointer_metadata(
    ...
    let member_descriptions = vec![
        ...
        MemberDescription {
            ...
            type_metadata: type_metadata(cx, vtable_field.ty, latinoc_span::DUMMY_SP),
            ...
            let (hash_kind, hash_value) = match hash {
                Some(hash) => {
                    let kind = match hash.kind {
                        latinoc_span::SourceFileHashAlgorithm::Md5 => llvm::ChecksumKind::MD5,
                        latinoc_span::SourceFileHashAlgorithm::Sha1 => llvm::ChecksumKind::SHA1,
                        latinoc_span::SourceFileHashAlgorithm::Sha256 => llvm::ChecksumKind::SHA256,
                    };
        ...
        match cached_discriminant_type_metadata {
            ...
            None => {
                ...
                let discriminant_base_type_metadata =
                    type_metadata(cx, discr.to_ty(tcx), latinoc_span::DUMMY_SP);
                ...
                .filter_map(|(kind, name)| {
                    if let GenericArgKind::Type(ty) = kind.unpack() {
                        ...
                        let actual_type_metadata =
                            type_metadata(cx, actual_type, latinoc_span::DUMMY_SP);
...
fn vtable_type_metadata(
    ...
    type_metadata(cx, vtable_type, latinoc_span::DUMMY_SP)
}
