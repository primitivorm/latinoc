...
// keeping the substitution token in this table. Ideally, this should be inside `latinoc_lexer`.
// However, we should first remove compound tokens like `<<` from `latinoc_lexer`, and then add
