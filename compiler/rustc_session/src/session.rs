...
pub use latinoc_ast::attr::MarkedAttrs;
pub use latinoc_ast::Attribute;
pub use latinoc_span::def_id::StableCrateId;
use latinoc_span::edition::Edition;
use latinoc_span::source_map::{FileLoader, MultiSpan, RealFileLoader, SourceMap, Span};
use latinoc_span::{sym, SourceFileHashAlgorithm, Symbol};
...
pub struct Session {
    ...
    /// `latinoc_codegen_llvm::back::symbol_names` module for more information.
