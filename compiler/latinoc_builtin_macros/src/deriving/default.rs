...
use latinoc_ast::EnumDef;
use latinoc_ast::VariantData;
use latinoc_ast::{Expr, MetaItem};
use rustc_errors::Applicability;
use latinoc_expand::base::{Annotatable, DummyResult, ExtCtxt};
...
fn validate_default_attribute(
    cx: &mut ExtCtxt<'_>,
    default_variant: &latinoc_ast::Variant,
) -> Result<(), ()> {
...
impl<'a, 'b> latinoc_ast::visit::Visitor<'a> for DetectNonVariantDefaultAttr<'a, 'b> {
    fn visit_attribute(&mut self, attr: &'a latinoc_ast::Attribute) {
        ...
        latinoc_ast::visit::walk_attribute(self, attr);
    }
    fn visit_variant(&mut self, v: &'a latinoc_ast::Variant) {
