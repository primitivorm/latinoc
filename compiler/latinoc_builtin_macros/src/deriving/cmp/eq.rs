...
use latinoc_ast::{self as ast, Expr, GenericArg, MetaItem};
...
pub fn expand_deriving_eq(
    ...
    let hidden = latinoc_ast::attr::mk_nested_word_item(Ident::new(sym::hidden, span));
    let doc = latinoc_ast::attr::mk_list_item(Ident::new(sym::doc, span), vec![hidden]);
