...
use latinoc_ast::{mut_visit, visit};
use latinoc_ast::{AstLike, Attribute};
use latinoc_expand::base::{Annotatable, ExtCtxt};
use latinoc_expand::config::StripUnconfigured;
use latinoc_expand::configure;
...
impl CfgEval<'_, '_> {
    ...
    fn configure_annotatable(&mut self, mut annotatable: Annotatable) -> Option<Annotatable> {
        ...
        let mut orig_tokens = latinoc_parse::nt_to_tokenstream(
            &nt,
        ...
        let mut flatten = FlattenNonterminals {
            nt_to_tokenstream: latinoc_parse::nt_to_tokenstream,
        ...
        let mut parser =
            latinoc_parse::stream_to_parser(&self.cfg.sess.parse_sess, orig_tokens, None);
