...
pub const EARLY_CONTEXT: [&str; 2] = ["latinoc_lint", "EarlyContext"];
#[allow(clippy::invalid_paths)] // `check_path` does not seem to work for macros
...
#[cfg(feature = "internal-lints")]
pub const IDENT: [&str; 3] = ["latinoc_span", "symbol", "Ident"];
#[cfg(feature = "internal-lints")]
pub const IDENT_AS_STR: [&str; 4] = ["latinoc_span", "symbol", "Ident", "as_str"];
...
#[cfg(feature = "internal-lints")]
pub const KW_MODULE: [&str; 3] = ["latinoc_span", "symbol", "kw"];
#[cfg(feature = "internal-lints")]
pub const LATE_CONTEXT: [&str; 2] = ["latinoc_lint", "LateContext"];
...
#[cfg(feature = "internal-lints")]
pub const SYMBOL: [&str; 3] = ["latinoc_span", "symbol", "Symbol"];
#[cfg(feature = "internal-lints")]
pub const SYMBOL_AS_STR: [&str; 4] = ["latinoc_span", "symbol", "Symbol", "as_str"];
#[cfg(feature = "internal-lints")]
pub const SYMBOL_INTERN: [&str; 4] = ["latinoc_span", "symbol", "Symbol", "intern"];
#[cfg(feature = "internal-lints")]
pub const SYMBOL_TO_IDENT_STRING: [&str; 4] = ["latinoc_span", "symbol", "Symbol", "to_ident_string"];
#[cfg(feature = "internal-lints")]
pub const SYM_MODULE: [&str; 3] = ["latinoc_span", "symbol", "sym"];
#[cfg(feature = "internal-lints")]
pub const SYNTAX_CONTEXT: [&str; 3] = ["latinoc_span", "hygiene", "SyntaxContext"];
